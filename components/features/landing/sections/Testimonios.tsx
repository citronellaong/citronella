...
const testimonios = [
  {
    ...
    avatar: '👩',
    quote: 'Desde que estoy en Citronella nunca más me faltó mi medicina. La calidad es superior y tengo la tranquilidad de saber que todo es legal y analizado en laboratorio.',
    tag: 'Paciente',
  ...
  },
  {
    ...
    avatar: '👨‍🌾',
    quote: 'Nunca imaginé que mi patio podía cambiar la vida de otras personas. Citronella me instaló todo y ahora 4 pacientes reciben su medicina mensual. Es un orgullo.',
    tag: 'Cultivador',
  ...
  },
  {
    ...
    avatar: '👩‍⚕️',
    quote: 'Cuidar a mi madre era desgastante. Delegar el suministro en Citronella le devolvió la paz a toda la familia. Atención humana y profesional en todo momento.',
    tag: 'Familiar',
