      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://www.instagram.com/citronellaong/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram de Citronella"
              className="w-11 h-11 rounded-full flex items-center justify-center border border-zinc-700 bg-zinc-900/40 backdrop-blur-sm text-zinc-300 hover:text-lime-300 hover:border-lime-400/40 hover:bg-zinc-800/60 transition-all duration-300"
            >
              <Instagram className="w-5 h-5" />
            </a>
            <a
              href="https://wa.me/5493517060614"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp de Citronella"
              className="w-11 h-11 rounded-full flex items-center justify-center border border-zinc-700 bg-zinc-900/40 backdrop-blur-sm text-zinc-300 hover:text-lime-300 hover:border-lime-400/40 hover:bg-zinc-800/60 transition-all duration-300"
            >
